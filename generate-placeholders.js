...
const pages = [
  ...
  { title: "Intune Scripts", path: "/endpoint/MEM/list-scripts" },
  { title: "Add Intune Script", path: "/endpoint/MEM/list-scripts/deploy" },
  { title: "Intune Script Templates", path: "/endpoint/MEM/list-scripts-templates" },
